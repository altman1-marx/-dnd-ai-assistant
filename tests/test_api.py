...
class APITests(unittest.TestCase):
    ...
    def test_create_coc_demo_and_summary(self) -> None:
        ...
        self.assertIn("ask mrs. ember about clue", summary["available_actions"])
        self.assertIn("speak to mrs. ember", summary["available_actions"])
        ...
        self.assertIn("ask mrs. ember about clue", action_groups["NPCs"])
    ...
    def test_coc_summary_suggests_first_aid_when_injured(self) -> None:
        ...
        self.assertIn("heal 1d3", summary["available_actions"])
